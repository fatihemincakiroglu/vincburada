...
const Page = async ({ params }: { params: Promise<{ handle: string }> }) => {
  ...
  if (!urun) {
    return redirect('/sepetli-vinc/modeller')
  }
        ...
        <div className="w-full lg:w-2/5 xl:w-1/3">
          <div className="sticky top-28 rounded-3xl border border-neutral-200 p-6 shadow-sm dark:border-neutral-700">
            ...
            <p className="mt-4 text-center text-xs text-neutral-500 dark:text-neutral-400">
              veya arayın: <a href="tel:05323039089" className="font-medium underline">0532 303 90 89</a>
            </p>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div className="p-5">
              <h3 className="text-base font-semibold">
                <Link href={`/sepetli-vinc/modeller/${d.handle}`} className="absolute inset-0"></Link>
                {d.title}
              </h3>
